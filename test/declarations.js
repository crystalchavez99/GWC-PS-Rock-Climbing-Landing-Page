...
module.exports = {
  ...
  categoryTextDiv: getRule('.category-text > div', declarations.categoryTextDiv.selector),
  categoryTextH3: getRule('.category-text h3', declarations.categoryTextH3.selector),
