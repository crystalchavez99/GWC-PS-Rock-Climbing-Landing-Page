...
describe('Hero, Sales Banner, & Categories', () => {
  ...
  it(`\`main.css\` should contain a \`${declarations.hero.selector}\` class @banner-text-css`, () => {
  ...
  it(`\`main.css\` should contain a \`${declarations.heroParagraph.selector}\` class @category-css`, () => {
    assert(category.assert, category.message);
  });

  it(`\`main.css\` should contain a \`${declarations.heroParagraph.selector}\` class @category-text-css`, () => {
