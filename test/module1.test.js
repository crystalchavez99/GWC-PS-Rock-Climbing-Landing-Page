...
describe('Utility Classes', () => {
  ...
  it(`\`main.css\` should contain a \`${declarations.container.selector}\` class @container-css`, () => {
  ...
  it(`\`main.css\` should contain the classes, \`${declarations.flex.selector}\`, \`${declarations.flexColumn.selector}\`, and \`${declarations.flexOne.selector}\` @flex-utilities-css`, () => {
  ...
  it(`\`main.css\` should contain the classes, \`${declarations.alignCenter.selector}\`, \`${declarations.center.selector}\`, and \`${declarations.spaceBetween.selector}\` @flex-alignment-utilities-css`, () => {
  ...
  it(`\`main.css\` should contain the classes, \`${declarations.btn.selector}\`, \`${declarations.btnDefault.selector}\`, and \`${declarations.btnPrimary.selector}\` @button-utilities-css`, () => {
  ...
  it(`\`main.css\` should contain a \`${declarations.formControl.selector}\` class @form-controls-css`, () => {
  ...
  it(`\`main.css\` should contain the classes, \`${declarations.textLight.selector}\`, \`${declarations.textSecondary.selector}\`, and \`${declarations.textPrimary.selector}\` @typography-utilities-css`, () => {
