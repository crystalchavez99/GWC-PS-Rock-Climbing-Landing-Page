...
describe('Header & Navigation', () => {
  ...
  it(`\`main.css\` should contain a \`${declarations.headerNav.selector}\` class @header-class`, () => {
    assert(headerNav.assert, headerNav.message);
  });

  it(`\`main.css\` should contain a \`${declarations.brand.selector}\` class @brand-class`, () => {
    assert(brand.assert, brand.message);
  });

  it(`\`main.css\` should contain a \`${declarations.logo.selector}\` class @logo-class`, () => {
  ...
  it(`\`main.css\` should contain a \`${declarations.navList.selector}\` class @navigation-list-css`, () => {
  ...
  it(`\`main.css\` should contain rules with the selectors, \`${declarations.profile.selector}\`, \`${declarations.account.selector}\`, and \`${declarations.accountLinks.selector}\` @profile-css`, () => {
